...
\begin{figure}[!htbp]
  ...
  \caption[La cena de los filósofos]{La cena de los filósofos\footnotemark}
  \label{fig:filosofos}
\end{figure}
...
\begin{figure}[!htbp]
  ...
  \caption[Góndola napolitana de Carlos II]{Góndola napolitana de Carlos II\footnotemark}
  \label{fig:falua}
\end{figure}
